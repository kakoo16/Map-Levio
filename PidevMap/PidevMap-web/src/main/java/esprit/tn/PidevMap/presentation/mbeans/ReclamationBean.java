...
public class ReclamationBean {
	...
	private List<Reclamation> filteredReclamation;
	...
	public void addReclamation() {
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage("Votre Reclamation est ajouter avec succes."));
	...
	public void mettreAjourReclamation() {
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage("Votre Reclamation est modifer avec succes."));
	...
	public void supprimer(int ReclamationId) {
		FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage("Cette Reclamation est supprimer avec succes."));
	...
	public List<Reclamation> getFilteredReclamation() {
		return filteredReclamation;
	}

	public void setFilteredReclamation(List<Reclamation> filteredReclamation) {
		this.filteredReclamation = filteredReclamation;
	}
